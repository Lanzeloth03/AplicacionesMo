...
class MainActivity : AppCompatActivity() {
    ...
    fun botones(){
        var buttons= arrayOf(R.id.btn7, R.id.btn8, R.id.btn9,R.id.btn1,R.id.btn2,R.id.btn3,
            R.id.btnMult, R.id.btn4, R.id.btn5, R.id.btn6, R.id.btnSum, R.id.btnIgual,
            R.id.btnPoten, R.id.btnRaiz,R.id.btnDiv,R.id.btnPi,R.id.btnBor)
    ...
    fun onClikListener(view:View){
        ...
        when(view.id){
            R.id.btn4, R.id.btn5, R.id.btn6, R.id.btn7, R.id.btn8, R.id.btn9, R.id.btn1, R.id.btn2, R.id.btn3->{
                appentContent(botonX.text.toString()) }
            R.id.btnMult, R.id.btnSum, R.id.btnPoten, R.id.btnRaiz->{
